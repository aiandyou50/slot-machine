...
2.  **베팅 및 스핀:**
      ...
      * 프론트엔드는 CSPIN 토큰을 게임 지갑으로 전송하는 트랜잭션을 생성하고, 사용자에게 서명을 요청합니다.
...
2.  **Betting and Spinning:**
      ...
      * The frontend creates a transaction to send CSPIN tokens to the game wallet and requests the user's signature.
