...
# 2. 현재 진행 중인 작업 (Active Issues & Bugs)

- **[BUG-003] doubleUp 기능의 불공정성:** 현재 doubleUp 기능이 Math.random()을 사용하여 검증 가능한 공정성 원칙(NFR-GAME-01)을 위반하고 있음. Commit-Reveal 스킴 도입 필요.
...
- **[NFR-GAME-01] 검증 가능한 공정성 (Provable Fairness)**
